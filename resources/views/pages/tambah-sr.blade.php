...
@section('content')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Senior Resident</li>
      </ol>
    </section>
    <section>
      <div class="container">
        <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Tambahkan Senior Resident Baru</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{ route('tambahuser.sr') }}">
                    {{ csrf_field() }}
